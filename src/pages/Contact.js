    ...
    <div className='contact'>
      ...
      <div className="contactContent">
        ...
        <div className="socialNetwork">
          <ul>
            <a href="https://linkedin.com/in/chougarabdelhadi" target="_blank"
              rel="noopener noreferrer">
              <h4>LinkedIn</h4>
              <i className="fab fa-linkedin"></i>
            </a>
            <a href="https://github.com/ChougarAbdelhadi" target="_blank"
              rel="noopener noreferrer">
              <h4>Github</h4>
              <i className="fab fa-github"></i>
            </a>
            <a href="https://www.facebook.com/Youva.23" target="_blank"
              rel="noopener noreferrer">
              <h4>Facebook</h4>
